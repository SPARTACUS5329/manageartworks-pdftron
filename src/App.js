...
function App() {
	...
	useEffect(() => {
		WebViewer(
			...
			documentViewer.addEventListener("documentLoaded", async () => {
				const measurementTool = instance.Core.documentViewer.getTool(
					"AnnotationCreateDistanceMeasurement"
				);

				measurementTool.setSnapMode(instance.Core.Tools.SnapModes.DEFAULT);
	...
	const exportModel = async (textures) => {
		...
		async function init() {
			...
			//cuboid
			object = new THREE.Mesh(new THREE.BoxGeometry(x, y, z), textureCubeCustom);
